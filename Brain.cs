...
public class Brain : MonoBehaviour {
	...
	void Update () {
		timeToBox = (this.transform.GetChild(1).gameObject).transform.GetComponent<BallCollides>().getTime();
		hitBox = (this.transform.GetChild(1).gameObject).transform.GetComponent<BallCollides>().getScored();
	}
